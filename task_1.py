...
class PaperBook(Book):
    ...
    def __repr__(self):
        return f"{type(self).__name__}(name={self.name!r}, author={self.author!r}, pages={self.pages!r})"
...
class AudioBook(Book):
    ...
    def __repr__(self):
        return f"{type(self).__name__}(name={self.name!r}, author={self.author!r}, duration={self.duration!r})"
